...
| Setup | `cro:cro-md` | Entrevista guiada: pasta, loja, conectores, jornada, plano de mensuração e voz do cliente. Escreve o CRO.md com as respostas e registra `@CRO.md` no CLAUDE.md. Um hook do plugin impede rodar na home, Desktop ou Downloads. |
